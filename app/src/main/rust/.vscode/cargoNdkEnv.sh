...
export PROJECT_ROOT="/home/tony/dev/WhisperVoiceKeyboard"
export ANDROID_SDK_HOME="/home/tony/Android/Sdk"
...
export TFLITEC_PREBUILT_PATH_X86_64_LINUX_ANDROID="$PROJECT_ROOT/app/src/main/jniLibs/x86_64/libtensorflowlite_c.so"
export TFLITEC_PREBUILT_PATH_AARCH64_LINUX_ANDROID="$PROJECT_ROOT/app/src/main/jniLibs/arm64-v8a/libtensorflowlite_c.so"
